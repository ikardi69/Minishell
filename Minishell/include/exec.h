...
// int		tokenize_input(int last_exit_status, t_ptr **head, char *input, t_tkn **tkn_head, t_env_copy **env_hd);
// int		tokenize_input(t_shell *shell, t_ptr **head, char *input, t_tkn **tkn_head);
int		tokenize_input(t_shell *shell, t_ptr **head, char *input, t_tkn **tkn_head);
// int		process_char_at_index(t_shell *shell, t_ptr **head, char *input, int *i, t_tkn **tkn_head);
int		process_char_at_index(t_shell *shell, t_parse_ctx *ctx);
// int		process_char_at_index(int last_exit_status, t_ptr **head, char *input, int *i, t_tkn **tkn_head, t_env_copy **env_hd);
int		handle_shell_pid(t_ptr **head, int *i);
// void	handle_variable_expansion(t_ptr **head, char *input, int *i, t_tkn **tkn_head, t_env_copy **env_hd);
